...
const insertAuthorPapers = async () => {
  try {
    await connection.query('TRUNCATE TABLE author_papers;');
    console.log('Truncated author_papers table.');

    await connection.query(insertAuthorPapersQuery, [authorPapersData]);
